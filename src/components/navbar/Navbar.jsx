  ...
  return (
    <>
        <nav className='container-navbar w-full flex justify-end sticky top-0 z-10'>
          ...
          <div className={`collapse-nav absolute w-full flex flex-col justify-center bg-black top-0 left-0 right-0 h-screen z-30 overflow-hidden items-center ${click ? 'block' : 'hidden'}`}>
